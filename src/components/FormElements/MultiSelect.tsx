					...
					<div className="relative z-20 inline-block w-full">
						<div className="relative flex flex-col items-center">
							<div ref={trigger} onClick={open} className="w-full">
								<div className="border-stroke focus:border-primary active:border-primary dark:border-dark-3 dark:bg-dark-2 mb-2 flex rounded-[7px] border-[1.5px] py-[9px] pr-3 pl-3 transition outline-none">
							...
							<div className="w-full px-4">
								<div
									className={`max-h-select shadow-1 dark:bg-dark-2 dark:shadow-card absolute top-full left-0 z-40 w-full overflow-y-auto rounded bg-white ${
										isOpen() ? '' : 'hidden'
									}`}
									ref={dropdownRef}
