...
export function Sidebar() {
	...
	return (
		<>
			...
			<aside
				className={cn(
					'dark:bg-gray-dark top-0 max-w-[290px] overflow-hidden border-r border-gray-200 bg-white transition-[width] duration-200 ease-linear dark:border-gray-800',
					isMobile ? 'fixed bottom-0 z-50' : 'sticky h-screen',
					isOpen ? 'w-full' : 'w-0',
				)}
					...
					<div className="mt-6 flex-1 overflow-y-auto pr-3 min-[850px]:mt-10">
						{NAV_DATA.map((section) => (
							<div key={section.label} className="mb-6">
								<h2 className="text-dark-4 dark:text-dark-6 mb-5 text-sm font-medium">
									{section.label}
								</h2>
